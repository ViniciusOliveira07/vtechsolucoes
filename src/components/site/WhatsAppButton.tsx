...
const WHATSAPP_MESSAGE = "Olá! Gostaria de saber mais sobre os serviços da Vtech Soluções.";
...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-40 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_10px_30px_-6px_rgba(37,211,102,0.55)] transition-all duration-300 hover:scale-110 hover:shadow-[0_14px_40px_-8px_rgba(37,211,102,0.8)] sm:bottom-6 sm:right-6 sm:h-15 sm:w-15"
    >
      {/* pulse ring */}
      <span
        aria-hidden
